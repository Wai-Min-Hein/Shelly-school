...
const SingleTeacherFlex = () => {
  return (
    <div className="flex flex-col lg:flex-row items-start justify-between gap-8 pb-8">
      <div className="basis-1/3 lg:sticky top-4">
      ...
      <div className="basis-2/3">
        <div className="flex items-center justify-between gap-6 border-b-2 border-secondary pb-6">
          <div className="basis-1/3 flex items-end justify-start gap-4">
            <div className="basis-[20%]">
              <img
                src="https://shelly.merku.love/wp-content/themes/shelly/assets/img/phone.svg"
        ...
        <div className="">
          ...
          <div className="">
            ...
            <div className="w-full h-4 rounded-xl bg-gray-300 overflow-hidden">
              <div className="h-full w-4/5 bg-secondary"></div>
            </div>
          </div>
        ...
        <div className="border border-secondary p-8 rounded-lg mt-8 relative single-teacher-box">
          <h4 className="single-teacher relative inline-block">
        ...
        <p>
          ...
          elementum egestas id sit amet elit. Praesent convallis ligula ac urna
          rhoncus euismod. Vestibulum maximus luctus magna, in sollicitudin
          lorem tincidunt id. Nunc aliquam nibh sagittis nibh luctus blandit.
          Quisque nec dignissim metus. Suspendisse eget turpis ante. Fusce non
          iaculis sem.
        </p>
      </div>
    </div>
...
export default SingleTeacherFlex;
